...
└── static/
    ├── common.css           # Shared styles (dark Gotham theme)
    ├── common.js            # Shared utilities (API, auth, sidebar, toast)
    ├── login.html / login.js          # Login page
    ├── register.html / register.js    # Registration page
    ├── dashboard.html / dashboard.js  # Dashboard with charts
    ├── resources.html / resources.js  # Resource inventory (equipment/vehicles/devices)
    ├── activity.html / activity.js    # Activity logs (manager/admin)
    ├── users.html / users.js          # User management (admin only)
    └── app-shell.html                 # Reference markup for shared sidebar
```
